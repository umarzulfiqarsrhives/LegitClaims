		...
		<div class="row">
			<div class=" col-md-13">
				<div class="panel-body" align="center">
					<div class="message">
						{$langs['labels']['Congratulation! Welcome to SevenHives']}
					</div>
					...
					<div class="likes">
						...
						<div class="g-plusone" data-size="standard" data-count="true" data-href='http://www.sevenhives.co.uk'></div>
					</div>
...
<footer class="modal-footer">
	<button class="btn btn-primary" type="button" id="start">{$langs['labels']['Go to SevenHives']}</button>
</footer>
<script>
	{literal}
	$(function(){
