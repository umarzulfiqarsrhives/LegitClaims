...
Espo.define('Advanced:Views.Quote.Record.ItemList', ['Views.Base', 'Collection'], function (Dep, Collection) {
    ...
    return Dep.extend({
        ...
        setup: function () {
            ...
            itemList.forEach(function (item, i) {
                ...
                this.getModelFactory().create('QuoteItem', function (model) {
                    model.set(item);
                    this.collection.push(model);
                    this.createView('item-' + i, 'Advanced:Quote.Record.Item', {
