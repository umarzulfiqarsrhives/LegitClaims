<div class="page-header">
    <h3>SevenHives CRM - Open Source CRM application</h3>
</div>
    ...
    <div class="col-md-8">
        <div class="panel panel-default">
            ...
            <section>
                ...
                <p>
                    Copyright &copy; 2014-2017 SevenHives CRM
                    <br>
                    Website: <a href="http://srhives.com/" target="_BLANK">srhives.com</a>.
                </p>
                <p>
                    SevenHives CRM is free software: you can redistribute it and/or modify
                    it under the terms of the GNU General Public License as published by
                    the Free Software Foundation, either version 3 of the License, or
                    (at your option) any later version.
                </p>
                <p>
                    SevenHives CRM is distributed in the hope that it will be useful,
                    but WITHOUT ANY WARRANTY; without even the implied warranty
                    of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU General Public License for more details.
                </p>
                <p>
                    You should have received a copy of the GNU General Public License
                    along with SevenHives CRM.
                </p>
                ...
                <p>
                    ...
                    these Appropriate Legal Notices must retain the display of the "SevenHives CRM" word.
                </p>
            </section>
            </div>
        </div>
